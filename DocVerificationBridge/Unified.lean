...
nav:
  ...
  - Verification:
    ...
    - Full Report: verification/coverage.md
...
def generateVerificationIndexMd (projectName : String) : String :=
  ...
  "## Quick Links\n\n" ++
  "- 📊 **[Summary](summary.md)** - Quick overview of statistics (loads fast!)\n" ++
  "- 📋 **[Full Report](coverage.md)** - Detailed breakdown by module with all declarations\n" ++
  ...
  "See the [Summary](summary.md) for statistics or the [Full Report](coverage.md) for the complete classification of all " ++
...
def generateUnifiedMkDocsSite (cfg : UnifiedConfig) (result : UnifiedResult) (modules : List String) : IO System.FilePath := do
  ...
  -- Generate summary page (quick-loading stats only)
